...
Den totale treningsbelastingen i multiple-set-gruppen er  høyere  enn i single-set-gruppen, og man vil forvente en dosis-respons økning i  både styrke og muskelmasse. Andre studier  har ikke vist samme forskjell på 1 og 3 setts trening 
...
Authors:
CUNHA, PAOLO M.1
NUNES, JOÃO PEDRO1joaonunes.jpn@hotmail.com
TOMELERI, CRISIELI M.1
NASCIMENTO, MATHEUS A.1,2
SCHOENFELD, BRAD J.3
ANTUNES, MELISSA1
GOBBO, LUIS ALBERTO1,4
TEIXEIRA, DENILSON1
CYRINO, EDILSON S.1
Source:
Journal of Strength & Conditioning Research Apr2020, Vol. 34 Issue 4, p1008 9p.

:::

Effects of Different Resistance Training Loads on the Muscle Quality Index in Older Women.
Authors:
Ribeiro, Alex S.1 (AUTHOR)
Picoloto, Alexandre1,2 (AUTHOR)
Nunes, João Pedro2 (AUTHOR) joaonunes.jpn@hotmail.com
Bezerra, Ewertton S.3 (AUTHOR)
Schoenfeld, Brad J.4 (AUTHOR)
Cyrino, Edilson S.2 (AUTHOR)
Source:
